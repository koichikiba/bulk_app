<x-app-layout>
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-white shadow-md">
        ...
        <h2 class="text-center text-lg font-bold pt-6 tracking-widest">修正画面</h2>
        ...
        <x-validation-errors :errors="$errors" />
                ...
                @foreach ($categories as $category)
                    <div>
                        <input type="radio" name="category_id" id="category{{ $category->id }}"
                            value="{{ $category->id }}" {{ old('category_id', $post->category_id) == $category->id ? 'checked' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="event"
                    ...
                    required placeholder="種目" value="{{ old('event', $post->event) }}">
            </div>
